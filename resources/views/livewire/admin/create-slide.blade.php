<div>
    ...
    <x-jet-dialog-modal wire:model="open">
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button wire:click="save" wire:loading.attr="disabled" wire:target="save, image, image2, image3, image4" class="disabled:opacity-25">
                Crear 
            </x-jet-danger-button>
