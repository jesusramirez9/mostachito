                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($homes as $item)
                            <tr>
                                ...
                                <td class="px-6 py-4 ">
                                    <div class="text-sm text-gray-900">{{ $item->url_yt }}</div>
                                </td>
    ...
    <x-jet-dialog-modal wire:ignore wire:model="open_edit">
        ...
        <x-slot name="content">
                ...
                <div>
                    @if ($image)
                        <img src="{{ $image->temporaryUrl() }}" class="mb-4 w-20 object-cover object-center h-20"
                            alt="">
                    @elseif($home->image)
                        <img src="{{ Storage::url($home->image) }}" class="w-20 object-cover object-center h-20"
                            alt="">
                    @endif
                </div>
                <div>
                    @if ($image2)
                        <img src="{{ $image2->temporaryUrl() }}" class="mb-4 w-20 object-cover object-center h-20"
                            alt="">
                    @elseif($home->image2)
                        <img src="{{ Storage::url($home->image2) }}" class="w-20 object-cover object-center h-20"
                            alt="">
                    @endif
                </div>
                <div>
                    @if ($image3)
                        <img src="{{ $image3->temporaryUrl() }}" class="mb-4 w-20 object-cover object-center h-20"
                            alt="">
                    @elseif($home->image3)
                        <img src="{{ Storage::url($home->image3) }}" class="w-20 object-cover object-center h-20"
                            alt="">
                    @endif
                </div>
                <div>
                    @if ($image4)
                        <img src="{{ $image4->temporaryUrl() }}" class="mb-4 w-20 object-cover object-center h-20"
                            alt="">
                    @elseif($home->image4)
                        <img src="{{ Storage::url($home->image4) }}" class="w-20 object-cover object-center h-20"
                            alt="">
                    @endif
                </div>
            ...
            <div class="mb-4 mt-4">
                ...
                <x-jet-input type="text" class="w-full" wire:model="home.url_yt"  />
                <x-jet-input-error for="home.url_yt" />
            </div>
            <div class="mb-4">
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button wire:click="update" wire:target="save,filepdf, image, image2, image3, image4" wire:loadin.attr="disabled:opacity-25">
                Actualizar
            </x-jet-danger-button>
        </x-slot>
            ...
            Livewire.on('deletePost', postId => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        Livewire.emitTo('admin.show-home', 'delete', postId)
